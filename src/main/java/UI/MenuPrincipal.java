...
public MenuPrincipal(){
 ...
 private Container menu() {
     ...
     caminos.addActionListener(e -> {
    	 ...
    	 listaCamino = ordenarCamino(listaCamino, "id");
     ...
     productos.addActionListener(e -> {
    	 ...
    	 listaProducto = ordenarProducto(listaProducto,"nombre");
...
Container sucursalScreen(ArrayList<Sucursal> listaSucursal) {
 ...
 private void buttonConfigSucursales(JButton button1) {
	 ...
	 Font customFont = CustomFont.loadCustomFont("CODE Light.otf",30f);
     button1.setFont(customFont);     button1.setForeground(Color.WHITE);
